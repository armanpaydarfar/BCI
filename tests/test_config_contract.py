...
#
# Note (2026-05-19, tiagobot branch): CLAUDE.md additionally lists
# TIAGOBOT_PORT as a guarded machine-local key, but the local
# ~/.claude/hooks/config-py-guard.sh does not yet include it. To keep
