...
def send_udp_message(sock, ip, port, message, logger=None, quiet=False):
    """
    ...
    Parameters:
        ...
        logger (optional): Logger instance to log the message.
        quiet (bool): If True, suppress all logging/printing.
    """
